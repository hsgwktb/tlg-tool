...
void Png2TlgConverter::convert(const std::string& inputPath, const std::string& outputPath)
{
    tTVPBaseBitmap bmp(inputPath);
    std::fstream fs(outputPath, std::fstream::out | std::fstream::binary);
